...
# coding: latin-1
#@Author :#TheEyeOfCyber&BuckeyeSecurity
...
print bcolors.BOLD + bcolors.WHITE + "                                              [+] Author :#Humayun Ali Khan"
print bcolors.BOLD + bcolors.WHITE + "                                              [+] TheEyeOfCyber&BuckeyeSecurity "
print bcolors.BOLD + bcolors.WHITE + "                                              [+] YOUTUBE CHANNEL : https://www.youtube.com/c/TheEyeOfCyberBuckeyeSecurity"
print bcolors.BOLD + bcolors.WHITE + "                                              [+] FACEBOOK : https://www.facebook.com/groups/2641086449498619/"
print bcolors.BOLD + bcolors.WHITE + "                                              [+] LINKEDIN : https://linkedin.com/in/theeyeofcyber"
print bcolors.BOLD + bcolors.WHITE + "                                              [+] GITHUB : https://github.com/TheEyeOfCyber"
